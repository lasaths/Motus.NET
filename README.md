...
|-----------|-------------------------------------------------------------------|
| Libraries on [nuget.org](https://www.nuget.org/profiles/lasaths) (latest published **0.17.0**; next cut **1.8.0** not published yet) | Rhino/GH UI that calls these APIs |
...
Changelog: [CHANGELOG.md](CHANGELOG.md). Package/`Directory.Build.props` targets **1.8.0** (not on nuget.org yet). Latest published NuGet remains **0.17.0** ([GitHub v0.17.0](https://github.com/lasaths/Motus.NET/releases/tag/v0.17.0)). Use sibling project references until **1.8.0** is tagged and published.
