...
|-----------|-------------------------------------------------------------------|
| Libraries on [nuget.org](https://www.nuget.org/profiles/lasaths) (latest published **1.8.0**; package identity **2.0.0** — publish on `v2.0.0` tag; **1.9.0** NuGet may still lag) | Rhino/GH UI that calls these APIs |
...
Changelog: [CHANGELOG.md](CHANGELOG.md). Package/`Directory.Build.props` targets **2.0.0** (NuGet publish on `v2.0.0` tag). Latest confirmed NuGet on nuget.org is **1.8.0** ([GitHub v1.8.0](https://github.com/lasaths/Motus.NET/releases/tag/v1.8.0)); **1.9.0** may lag the index. Use sibling project references / Prefer UseLocal until **2.0.0** is published.
